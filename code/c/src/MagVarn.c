...
static float CalcMagVarn(double lat, double lon, float altitude, Int16 year) {     
      static int maxdeg;
      ...
      /*
       * this algorithm uses -ve numbers for west, which
       * is opposite to how FM uses them
       *
       */
